var plugins = [{
      ...
      plugin: require('/workspace/blog3/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/workspace/blog3/gatsby-ssr'),
      options: {"plugins":[]},
    }]
